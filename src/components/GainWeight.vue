...
<!--      <template>-->
<!--        <nav>-->
<!--          <v-app-bar flat app color="teal accent-3" dense dark>-->
<!--            <v-spacer></v-spacer>-->
<!--            <v-btn to="/profile" color="white&#45;&#45;text">-->
<!--              <v-icon>home</v-icon>-->
<!--            </v-btn>-->
<!--          </v-app-bar>-->
...
<!--                        <v-btn rounded color="teal accent-3" dark>NEXT</v-btn>-->
<!--                      </div>-->
<!--                    </v-col>-->
...
<!--    methods: {-->
<!--      initialize() {-->
<!--        console.log("test") // just to show in console-->
<!--      }-->
<!--    }-->
