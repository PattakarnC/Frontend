...
<!--                        </v-row>-->
<!--&lt;!&ndash;                        <h1&ndash;&gt;-->
<!--&lt;!&ndash;                          class="text-center display-2 teal&#45;&#45;text text&#45;&#45;accent-3"&ndash;&gt;-->
<!--&lt;!&ndash;                        >Your BMI</h1>&ndash;&gt;-->
<!--                        <v-sparkline-->
<!--                          :value="value"-->
<!--                          :gradient="gradient"-->
<!--                          :smooth="radius || false"-->
...
<!--                      <div class="text-center mb-10 text-h4 ">-->
<!--                          Overweight-->
<!--                      </div>-->
<!--                    </v-col>-->
...
<!--                      </div>-->
<!--                      <div class="text-center my-5">-->
<!--                        <v-btn rounded outlined dark @click="step++">LOSE WEIGHT</v-btn>-->
<!--                      </div>-->
<!--                    </v-col>-->
<!--                  </v-row>-->
<!--                </v-window-item>-->
